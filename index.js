...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/background.png", "start": 0, "end": 41657}, {"filename": "/assets/cursor.png", "start": 41657, "end": 41942}, {"filename": "/assets/icon.ico", "start": 41942, "end": 44935}, {"filename": "/assets/mainfont.ttf", "start": 44935, "end": 255623}, {"filename": "/assets/output.wav", "start": 255623, "end": 285525}, {"filename": "/assets/pipe-down.png", "start": 285525, "end": 290151}, {"filename": "/assets/pipe-up.png", "start": 290151, "end": 292678}, {"filename": "/assets/sfx_hit.wav", "start": 292678, "end": 389236}, {"filename": "/assets/sfx_point.wav", "start": 389236, "end": 566690}, {"filename": "/assets/sfx_wing.wav", "start": 566690, "end": 596560}, {"filename": "/assets/start.png", "start": 596560, "end": 598162}, {"filename": "/assets/yellowbird-downflap.png", "start": 598162, "end": 598588}, {"filename": "/assets/yellowbird-gameover.png", "start": 598588, "end": 607741}, {"filename": "/assets/yellowbird-midflap.png", "start": 607741, "end": 608166}, {"filename": "/assets/yellowbird-upflap.png", "start": 608166, "end": 608593}], "remote_package_size": 608593});

  })();

// end include: /tmp/tmpq1rp0ljg.js
// include: /tmp/tmpjbvunw4c.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpjbvunw4c.js
// include: /tmp/tmp31ylgor6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp31ylgor6.js
...
var ASM_CONSTS = {
  145512: () => { if (document.fullscreenElement) return 1; },  
 145558: () => { return document.getElementById('canvas').width; },  
 145610: () => { return parseInt(document.getElementById('canvas').style.width); },  
 145678: () => { document.exitFullscreen(); },  
 145705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 145778: () => { if (document.fullscreenElement) return 1; },  
 145824: () => { return document.getElementById('canvas').width; },  
 145876: () => { return screen.width; },  
 145901: () => { document.exitFullscreen(); },  
 145928: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 146061: () => { return window.innerWidth; },  
 146087: () => { return window.innerHeight; },  
 146114: () => { if (document.fullscreenElement) return 1; },  
 146160: () => { return document.getElementById('canvas').width; },  
 146212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 146280: () => { if (document.fullscreenElement) return 1; },  
 146326: () => { return document.getElementById('canvas').width; },  
 146378: () => { return screen.width; },  
 146403: () => { return window.innerWidth; },  
 146429: () => { return window.innerHeight; },  
 146456: () => { if (document.fullscreenElement) return 1; },  
 146502: () => { return document.getElementById('canvas').width; },  
 146554: () => { return screen.width; },  
 146579: () => { document.exitFullscreen(); },  
 146606: () => { if (document.fullscreenElement) return 1; },  
 146652: () => { return document.getElementById('canvas').width; },  
 146704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 146772: () => { document.exitFullscreen(); },  
 146799: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 146857: () => { return screen.width; },  
 146882: () => { return screen.height; },  
 146908: () => { return window.screenX; },  
 146935: () => { return window.screenY; },  
 146962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 147015: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 147086: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 147143: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 147399: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 147470: () => { if (document.fullscreenElement) return 1; },  
 147516: () => { return window.innerWidth; },  
 147542: () => { return window.innerHeight; },  
 147569: () => { if (document.pointerLockElement) return 1; },  
 147616: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 149774: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 149938: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 150042: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 150213: ($0, $1, $2, $3, $4, $5) => { var deviceType = $0; var channels = $1; var sampleRate = $2; var bufferSize = $3; var pIntermediaryBuffer = $4; var pDevice = $5; if (typeof(window.miniaudio) === 'undefined') { return -1; } var device = {}; var audioContextOptions = {}; if (deviceType == window.miniaudio.device_type.playback && sampleRate != 0) { audioContextOptions.sampleRate = sampleRate; } device.webaudio = new (window.AudioContext || window.webkitAudioContext)(audioContextOptions); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; var channelCountIn = 0; var channelCountOut = channels; if (deviceType != window.miniaudio.device_type.playback) { channelCountIn = channels; } device.scriptNode = device.webaudio.createScriptProcessor(bufferSize, channelCountIn, channelCountOut); device.scriptNode.onaudioprocess = function(e) { if (device.intermediaryBufferView == null || device.intermediaryBufferView.length == 0) { device.intermediaryBufferView = new Float32Array(Module.HEAPF32.buffer, pIntermediaryBuffer, bufferSize * channels); } if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { for (var iChannel = 0; iChannel < channels; iChannel += 1) { var inputBuffer = e.inputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { intermediaryBuffer[iFrame*channels + iChannel] = inputBuffer[iFrame]; } } _ma_device_process_pcm_frames_capture__webaudio(pDevice, bufferSize, pIntermediaryBuffer); } if (deviceType == miniaudio.device_type.playback || deviceType == miniaudio.device_type.duplex) { _ma_device_process_pcm_frames_playback__webaudio(pDevice, bufferSize, pIntermediaryBuffer); for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { var outputBuffer = e.outputBuffer.getChannelData(iChannel); var intermediaryBuffer = device.intermediaryBufferView; for (var iFrame = 0; iFrame < bufferSize; iFrame += 1) { outputBuffer[iFrame] = intermediaryBuffer[iFrame*channels + iChannel]; } } } else { for (var iChannel = 0; iChannel < e.outputBuffer.numberOfChannels; ++iChannel) { e.outputBuffer.getChannelData(iChannel).fill(0.0); } } }; if (deviceType == miniaudio.device_type.capture || deviceType == miniaudio.device_type.duplex) { navigator.mediaDevices.getUserMedia({audio:true, video:false}) .then(function(stream) { device.streamNode = device.webaudio.createMediaStreamSource(stream); device.streamNode.connect(device.scriptNode); device.scriptNode.connect(device.webaudio.destination); }) .catch(function(error) { console.log("Failed to get user media: " + error); }); } if (deviceType == miniaudio.device_type.playback) { device.scriptNode.connect(device.webaudio.destination); } device.pDevice = pDevice; return miniaudio.track_device(device); },  
 153041: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 153107: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 153500: ($0) => { miniaudio.untrack_device_by_index($0); },  
 153543: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 153668: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
